...
train_dataloader = dict(
    batch_size=1, num_workers=2, dataset=dict(pipeline=train_pipeline, metainfo=dict(classes='ship')))
val_dataloader = dict(batch_size=1, num_workers=2, dataset=dict(pipeline=test_pipeline, metainfo=dict(classes='ship')))
...
evaluation = dict(interval=1, metric='segm', save_best='auto')
