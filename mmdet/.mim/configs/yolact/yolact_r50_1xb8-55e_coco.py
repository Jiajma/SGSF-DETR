...
train_dataloader = dict(
    ...
    num_workers=2,
    batch_sampler=None,
    dataset=dict(metainfo=dict(classes=('ship',)), pipeline=train_pipeline))
val_dataloader = dict(batch_size=1, num_workers=2, dataset=dict(metainfo=dict(classes=('ship',)), pipeline=test_pipeline))
